...
* @brief   Private declarations for the ADC driver.
* @details Contains register bit definitions and internal helper declarations.
* @version 1.0
* @date    8/2/2026
...
// Global pointer used to notify the application layer once an
// interrupt-driven conversion has finished (set via ADC_SetCallback)
static void (*ADC_CallBackPtr)(uint16_t) = Null;
